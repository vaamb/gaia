...
from gaia.hardware.abc import Hardware, OneWireAddressMixin, SensorMixin
...
class BS18B20(OneWireAddressMixin, TemperatureSensor, Hardware):
...
onewire_sensor_models: dict[str, Type[SensorMixin]] = {
