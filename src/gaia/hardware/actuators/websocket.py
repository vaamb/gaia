...
from gaia.hardware.abc import Actuator, Dimmer, Switch, WebSocketAddressMixin


class WebSocketSwitch(WebSocketAddressMixin, Switch):
...
class WebSocketDimmer(WebSocketAddressMixin, Dimmer):
